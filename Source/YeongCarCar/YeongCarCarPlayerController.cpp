...
void AYeongCarCarPlayerController::BeginPlay()
{
	Super::BeginPlay();
	
	// spawn the UI widget and add it to the viewport
	VehicleUI = CreateWidget<UYeongCarCarUI>(this, VehicleUIClass);
...
void AYeongCarCarPlayerController::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AYeongCarCarPlayerController::OnPossess(APawn* InPawn)
{
