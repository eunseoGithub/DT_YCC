...
#include "YeongCarCarPlayerController.generated.h"
 ...
 */
UCLASS(abstract)
class YEONGCARCAR_API AYeongCarCarPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<UYeongCarCarUI> VehicleUIClass;
